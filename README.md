...
https://discmagnet.shinyapps.io/crib/
...
This final line of code retrieves the point value of your hand from the run vector.
...
[D] `sum(2^(C-1))+1` finishes the conversion computation.
